...
import 'package:black_dragon_app/src/ui/utils/routes/routes.dart' as router;
        ...
        child: Column(
          children: [
            ...
            _buildExperienceRow(
                company: "Instructor",
                position:
                    "${snapshot.data.intructor.nombre} ${snapshot.data.intructor.apellido}",
                duration: "",
                page: IntructorPage()),
            _buildExperienceRow(
        ...
        child: Column(
          children: [
            Container(
              ...
              child:
                  Text(snapshot.data.motivacion, textAlign: TextAlign.justify),
            ),
          ],
        ),
      );
